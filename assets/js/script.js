...
const year2Questions = [
  ...
  {
    question:
      "Actress Julie Walters portrays what character in the Harry Potter movies?",
    answers: [
  ...
  {
    question:
      "Who is the Defense Against the Dark Arts professor in 'Harry Potter and the Prisoner of Azkaban'?",
    answers: [
  ...
  {
    question:
      "How many presents does Dudley Dursley complain about not receiving on his birthday in 'Harry Potter and the Sorcerer's Stone'?",
    answers: [
  ...
  {
    question:
      "In 'Harry Potter and the Half-Blood Prince', Ginny Weasley joins the Gryffindor Quidditch team playing what position?",
    answers: [
      { text: "Beater", correct: false },
...
const year3Questions = [
  ...
  {
    question:
      "Which Hogwarts house did the Sorting Hat consider putting Hermione in before deciding on Gryffindor?",
    answers: [
      { text: "Slytherin", correct: false },
      { text: "Hufflepuff", correct: false },
      { text: "Ravenclaw", correct: true },
  ...
  {
    question:
      "What is the name of the couple that attends dinner at the Dursley's when Dobby shows up to stop Harry from retuning to Hogwarts?",
    answers: [
  ...
  {
    question:
      "In the book version of 'Harry Potter and the Half-Blood Prince', who finds Harry on the Hogwarts Express after Malfoy breaks his nose and leaves him under the Invisibility Cloak?",
    answers: [
